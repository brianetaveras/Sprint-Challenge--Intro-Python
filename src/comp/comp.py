...
print("Starts with D:")
a = [x.name for x in humans if x.name.lower().startswith('d')]
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [x.name for x in humans if x.name.lower().endswith('e')]
print(b)
...
c = [x.name for x in humans if x.name.lower()[0] in l]
print(c)
